...
# Crear una instancia de la clase y mostrar el atributo
mi_objeto = MiClase("Un valor")
mi_objeto.mostrar_atributo()
...
print("Longitud de la cadena 'Python':", longitud_cadena)
print("Convertir 'hola' a mayúsculas:", mayusculas)
print("Convertir 'HOLA' a minúsculas:", minusculas)
print("Reemplazar en la cadena:", reemplazo)